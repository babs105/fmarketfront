...
const AddIntrusion = (props) => {
  ...
  const onSubmit = (data) => {
    ...
    intrusionService.create(data).then(
      (response) => {
        console.log("data new", response.data);
        setMessage("Ajout intrusion succes");
        setSuccessful(true);
        setLoading(false);
      },
      (error) => {
    ...
    <>
      <nav aria-label="breadcrumb">
        <ol className="breadcrumb">
          ...
          <li className="breadcrumb-item active">Ajout intrusion</li>
        </ol>
      </nav>
      <div className="mt-4">
        {/* <div className="d-flex justify-content-between"> */}
        <h4 className="text-primary">Ajout intrusion</h4>
        {/* </div> */}
        <hr className="mb-4" />
