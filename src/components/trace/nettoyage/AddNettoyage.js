...
const AddNettoyage = (props) => {
  ...
  const onSubmit = (data) => {
    ...
    nettoyageService.create(data).then(
      (response) => {
        console.log("data new", response.data);
        setMessage("Ajout nettoyage succes");
        setSuccessful(true);
        setLoading(false);
      },
      (error) => {
    ...
    <>
      <nav aria-label="breadcrumb">
        <ol className="breadcrumb">
          ...
          <li className="breadcrumb-item active">Ajout Nettoyage</li>
        </ol>
      </nav>
      <div className="mt-4">
        {/* <div className="d-flex justify-content-between"> */}
        <h4 className="text-primary">Ajout nettoyage</h4>
        {/* </div> */}
        <hr className="mb-4" />
